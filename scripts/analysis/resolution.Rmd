...
```{r}
st_write(fee_richness, "../data/output/fee_richness_res5km.shp",append = FALSE)
```
...
```{r}
st_write(easement_richness1, "../data/output/easement_richness1_res5km.shp", append = FALSE)
```
...
```{r}
st_write(easement_richness2, "../data/output/easement_richness2_res5km.shp", append = FALSE)
```
...
```{r}
st_write(background_richness, "../data/output/background_richness_res5km.shp", append = FALSE)
```
